 ...
 *   3. features  — юзкейсы (sign-in, edit-profile, ...): интерактивные сценарии поверх entities.
 *   4. widgets   — крупные самостоятельные блоки UI (app-layout, auth-layout).
 *   5. pages     — экраны, тонкая композиция widgets/features/entities под конкретный роут.
 *   6. app       — композиционный корень (App.tsx, router.tsx, routes/, app.module.ts) — видит всё.
 *
