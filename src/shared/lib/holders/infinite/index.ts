export type { IInfiniteHolderOptions, IInfiniteHolderResult } from "./infinite-holder";
...
export type { UseInfiniteOptions, UseInfiniteResult } from "./use-infinite-holder";
